      ...
      *****************************************************************
      *  MINES2D - Minesweeper for IBM i (Cobol/400 OPM version)     *
      *  CFOX1 library - by cfox                                      *
      *  Move with WASD. Press Enter to reveal a cell.               *
      *  Reveal all safe cells to win.                                *
      *  Compiler: CRTCBLPGM (OPM Cobol/400)                        *
      *****************************************************************
       PROGRAM-ID. MINES2D.
      ...
      * Working variables
       01  TIM.
           ...
           03 TIM-SS         PIC 99.
           03 TIM-HS         PIC 99.
       77  SEED              PIC S9(18) COMP.
       77  SEED-WORK         PIC S9(18) COMP.
       77  SEED-REM          PIC S9(18) COMP.
       ...
       PM.
           PERFORM VARYING R FROM 1 BY 1 UNTIL R > 20
               PERFORM VARYING C FROM 1 BY 1 UNTIL C > 40
                   IF NOT (R >= P-ROW - 1 AND R <= P-ROW + 1 AND
